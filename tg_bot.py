...
def start_message(message):
    bot.reply_to(
        message, 
        """Привет! Мы команда Мастер на GPT-унами. Отправьте в сообщении zip архив для обработки.

Для нас очень важно, чтобы проект zip архив сразу после распаковки содеражл весь проект с root.
Т.е все файлы и внутренние папки должны быть доступны сразу после разархивации, а не лежать все вместе в одной папке. 
Если это условие не соблюсти, то качество ответов сильно снизится

Если вы хотите выслать 1 файл, то также положите его в архив. В случае возникновения проблем пишите https://t.me/NekroniX588
        """
    )
